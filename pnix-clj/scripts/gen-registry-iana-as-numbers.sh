...
SRC="$ROOT/ingest/registry/iana-as-numbers/as-numbers.xml"
OUT="$ROOT/stdlib/lib/corpus/iana-as-numbers.generated.px"
python3 - <<'PY' "$SRC" "$OUT"
...
lines=['{']
lines.append('  schema = "registry.iana.as_numbers.v1";')
lines.append('  source = {')
lines.append('    project = "IANA Autonomous System Numbers";')
lines.append('    license = "IANA any-purpose registry terms";')
lines.append('    retrieved_from = "https://www.iana.org/assignments/as-numbers/as-numbers.xml";')
lines.append('  };')
