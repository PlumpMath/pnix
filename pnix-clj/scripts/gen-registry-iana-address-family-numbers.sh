...
SRC="$ROOT/ingest/registry/iana-address-family-numbers/address-family-numbers.xml"
OUT="$ROOT/stdlib/lib/corpus/iana-address-family-numbers.generated.px"
python3 - <<'PY' "$SRC" "$OUT"
...
lines=['{']
lines.append('  schema = "registry.iana.address_family_numbers.v1";')
lines.append('  source = {')
lines.append('    project = "IANA Address Family Numbers";')
lines.append('    license = "IANA any-purpose registry terms";')
lines.append('    retrieved_from = "https://www.iana.org/assignments/address-family-numbers/address-family-numbers.xml";')
lines.append('  };')
