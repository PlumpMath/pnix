...
(let [report (mp/report)]
  (assert (= 199 (:fixture-count report)))
...
pnix-clj 파일은 실제 199개 코퍼스를 4-레인에 통과시키고 `ready?` 개수를
집계한다.
...
;; cases: 199개 소스 + expected import-module 목록
(mp/cases)
