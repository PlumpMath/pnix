...
green 유지. 권위 있는 범위 선언은
[`pnix-hy/docs/IMPLEMENTATION.md`](pnix-hy/docs/IMPLEMENTATION.md) §4(범위
선언)가 지배한다 — 의도적 placeholder 목록은
[`pnix-hy/docs/BUGS.md`](pnix-hy/docs/BUGS.md) 참고(예전 `SCOPE_LOCK.md`의
후신, 2026-08-20 통합).
