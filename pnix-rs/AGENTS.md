...
green 유지. 로컬 범위 선언은
[`pnix-rs/docs/IMPLEMENTATION.md`](pnix-rs/docs/IMPLEMENTATION.md) §6
"이 lane의 개발 원칙"이 지배한다(2026-08-20 이전엔 `SCOPE_LOCK.md`라는
별도 파일이었으나 그 문서로 흡수됨). 알려진 제한/의도적 held는
[`pnix-rs/docs/BUGS.md`](pnix-rs/docs/BUGS.md), 미확정 로드맵은
[`pnix-rs/docs/PLANS.md`](pnix-rs/docs/PLANS.md), 열린 작업은
[`pnix-rs/docs/TODO.md`](pnix-rs/docs/TODO.md).
